...
<div class="sidebar">
    ...
    <ul class="nav-links">
        ...
        <li><a href="<?php echo BASE_URL; ?>/modules/staff/products.php" <?php echo $current_page === 'products.php' ? 'class="active"' : ''; ?>><i class="fas fa-store"></i> Products</a></li>
        ...
        <li><a href="<?php echo BASE_URL; ?>/modules/staff/messages.php" <?php echo $current_page === 'messages.php' ? 'class="active"' : ''; ?>>
