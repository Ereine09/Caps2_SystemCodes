...
<head>
    <meta charset="UTF-8">
    <title>Reward Redemption - INFOSEC <?php echo ucfirst($role); ?></title>
    ...
    <div class="main-content">
        ...
        <div class="stats-container" style="display: flex; gap: 20px; margin-bottom: 30px;">
            <div class="card" style="background: white; padding: 20px; border-radius: 12px; flex: 1; text-align: center; box-shadow: 0 4px 6px rgba(0,0,0,0.05);">
                <i class="fas fa-gift" style="font-size: 2rem; color: #4a3e94;"></i>
            ...
            <form method="POST" style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; align-items: start;">
                ...
                <div style="grid-column: span 2; display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    ...
                    <div style="grid-column: span 2; margin-top: 10px;">
                        <button type="submit" name="redeem_reward" id="redeem-button" style="background: #9b59b6; color: white; border: none; padding: 12px 30px; border-radius: 8px; cursor: pointer; font-weight: bold; font-size: 1rem;">
                            Redeem Now
                        </button>
                ...
                <div style="padding: 15px; background: #f9f9f9; border-radius: 8px; border-left: 4px solid #9b59b6; font-size: 0.9rem;">
                    <h4 style="margin-top: 0; color: #4a3e94; margin-bottom: 10px;">Reward Claiming Guides</h4>
                    <ul style="list-style: none; padding: 0; margin: 0; line-height: 1.4;">
                        <li style="margin-bottom: 10px;">
                            <i class="fas fa-check-circle" style="color: #9b59b6;"></i> 
                            <strong>Free Items (1,000 pts):</strong><br>Redeem for one free item of your choice.
                        </li>
                        <li style="margin-bottom: 10px;">
                            <i class="fas fa-check-circle" style="color: #9b59b6;"></i> 
                            <strong>Free 0.5kg Cat Food (500 pts):</strong><br>Redeem for a half-kilo bag.
                        </li>
                        <li>
                            <i class="fas fa-check-circle" style="color: #9b59b6;"></i> 
                            <strong>Free Treat Pack (250 pts):</strong><br>Small pack of delicious treats.
                        </li>
                    </ul>
                </div>
