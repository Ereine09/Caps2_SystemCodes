 ...
 *
 * Expected actions (extend as needed):
 * - picked_up
 * - out_for_delivery
 * - delivered
 * - cancelled
...
try {
  ...
  // Map rider status -> backend enum values (approximation)
  $order_status_map = [
  ...
  // Notify customer via existing helper (email/in_app depends on helper impl)
